...
const DEFAULT_PREVIEW_PROMPT =
  ...
  "Draw the new character fully in the cover's own illustration art style - NOT " +
  "photo-realistic and not a pasted photo - so the redrawn child blends in as if " +
  "hand-drawn by the same artist.\n\n" +
