...
const DEFAULT_PREVIEW_PROMPT =
  ...
  "MAIN TASK - put THIS child into the cover. Redraw the cover's main character so " +
  "it is a portrait of the child in the photo. The single most important result is " +
  "that the child (and their parents) instantly recognise their own face on the " +
  "cover. Recognisable likeness outweighs style matching wherever the two conflict.\n\n" +
  "FACE - copy, do not reinterpret. Reproduce the child's real facial geometry from " +
  "the photo as faithfully as a careful portrait painter would: the exact face shape " +
  "and width, jawline and chin, cheek structure, forehead height, eye shape, eye " +
  "spacing and eye colour, eyebrow shape and thickness, nose shape and size, mouth " +
  "shape, lip thickness, smile and visible teeth, ear shape, skin tone, and every " +
  "distinctive feature (freckles, dimples, moles, birthmarks, glasses, gap teeth, " +
  "braces). These proportions are measurements to be copied, not stylistic choices.\n\n" +
  "HAIR - copy exactly: the same length, shape, style, parting, colour, and texture " +
  "as in the photo, fully replacing the original character's hairstyle (if the " +
  "original has long hair but the child has short hair, the result must have short " +
  "hair). Match the child's gender: a boy if the photo is a boy, a girl if it is a " +
  "girl.\n\n" +
  "STYLE - a light touch only. Render the child with the cover's illustration " +
  "technique so they belong in the scene: the same linework, brushwork, shading, " +
  "lighting, and colour palette. Apply this to the RENDERING ONLY. Roughly 85% of " +
  "the result should be the child's true face and 15% the illustration technique - " +
  "a real child lightly painted, not a cartoon character wearing their features. " +
  "Think illustrated portrait, not caricature or animated-film character.\n\n" +
  "The face may stay noticeably more photographic and more detailed than the rest " +
  "of the cover. That contrast is intended and correct - do NOT simplify the face " +
  "to match the flatness or the level of abstraction of the background, the " +
  "clothing, or any other character on the cover. If the surrounding art is very " +
  "simplified or heavily stylised, keep the face realistic anyway; blend the two " +
  "only through lighting and colour, never by simplifying the child's features.\n\n" +
  "NEVER do any of these, even if the cover's original character has them:\n" +
  "- enlarge the eyes or make them rounder, glossier, or more doll-like\n" +
  "- shrink, simplify, or button-ify the nose\n" +
  "- shrink the chin or jaw, or enlarge the head relative to the body\n" +
  "- smooth the face into a generic soft oval or erase its asymmetry\n" +
  "- widen the smile or change which teeth show\n" +
  "- lighten, darken, or saturate the skin tone away from the photo\n" +
  "- make the child look younger, older, cuter, thinner, or more \"perfect\"\n" +
  "- blend the child with the original character's face - the original face must be " +
  "entirely gone\n\n" +
...
// Exported so sibling modules (lib/customer-tag.js) reuse this cached-token
// auth instead of re-implementing the client-credentials dance.
