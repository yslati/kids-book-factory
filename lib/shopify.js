...
const DEFAULT_PREVIEW_PROMPT =
  ...
  "features, hair style and color, skin tone, apparent age, and apparent gender. " +
  ...
  "IMPORTANT: the new character's gender MUST match the child in the photo, even if " +
  "the original cover character is a different gender. Redraw the character as a boy " +
  "if the child is a boy, or a girl if the child is a girl. Change the hairstyle, " +
  "clothing/outfit, and any accessories so they clearly read as the child's gender " +
  "and age — do NOT keep the original character's feminine or masculine styling when " +
  "it conflicts with the uploaded child.\n\n" +
  "Keep everything else about the cover the same: art style, background, scene, " +
  "composition, layout, lighting, mood, and the character's overall pose and role. " +
  "The goal is a believable picture of THIS child, of the correct gender, as the " +
  "hero of the cover.\n\n" +
