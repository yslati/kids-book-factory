...
const DEFAULT_PREVIEW_PROMPT =
  "Take the main character on this book cover (first image) and replace their " +
  "face with the child's face from the second image. Keep the cover's art style, " +
  "colors, composition, and layout exactly the same, and blend the new face " +
  "naturally into the illustration. Do not change or add any title text.";
